...
export function ProductSection() {
  ...
  <a
    href="/products"
    className="rounded-md bg-primary px-8 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-0.5 hover:bg-primary/90"
  >
    View More Products
  </a>
</div>
