    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#2a8dff] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-red-900/30">
              Yantrakriaya<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              Yantrakriaya<span className="text-black">.</span>
            </motion.div>
          </motion.div>
